...
app = FastAPI(title="Weather API - Serverless")

@app.get("/")
async def root():
    return {"message": "Weather API is running on Cloud Run", "serverless": True}

@app.get("/health")
async def health_check():
    return {"status": "healthy", "deployment": "cloud-run-serverless"}
